...
Answer: A token is generally used to represent only security information, it is capable of holding additional free-form data that can be attached while the token is being created.

2. What steps can you take in your web apps to keep your data secure?

Answer: There are many ways you can do this I will give a few: Always back up your data in any event of a security breach or malware infection you will need to take to store it somewhere for when you resolve this issue and want to go live again. Another way is to scan the website for vulnerabilities often, by doing a security check at least once a week.  

3. Describe how web servers work.

Answer: The primary function of a web server is to store, process and deliver web pages to clients. The communication between client and server takes place using the Hypertext Transfer Protocol 


4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

Answer: By using the read method using the get function to retrieve data.
